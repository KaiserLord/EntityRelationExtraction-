...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, data):
        ...
        vocab_file = 'd:\\GitHub\\RE\\bert-base-chinese\\vocab.txt'
    ...
    def get_token2id(self):
        self.word2id = {}
        with codecs.open('vec.txt', 'r', encoding='utf-8') as f:
            cnt = 0
            for line in f.readlines():
                self.word2id[line.split()[0]] = cnt
                cnt += 1
...
if __name__ == '__main__':
    ...
    train_loader, dev_loader, test_loader = process.get_train_dev_data('d:\\GitHub\\RE\\data\\train_data.json')
